...
async def run_evaluation(
    ...
    run = EvaluationRun(
        ...
        config_snapshot={
            ...
            "router_model": effective_settings.llm_router_model,
            "generation_model": effective_settings.llm_generation_model,
            ...
            "enable_gliner_ner": effective_settings.enable_gliner_ner,
            "gliner_model": effective_settings.gliner_model,
            "gliner_threshold": effective_settings.gliner_threshold,
            "enable_context_binder": effective_settings.enable_context_binder,
